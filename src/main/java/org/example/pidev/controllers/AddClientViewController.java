...
public class AddClientViewController implements Initializable {
    ...
    private void handleSave() {
        try {
            ...
            newClient.setCreatedAt(java.time.LocalDateTime.now()); // Set current date and time
            ...
            alert.setContentText("An error occurred while adding the client: " + e.getMessage());
            alert.showAndWait();
        }
    }
